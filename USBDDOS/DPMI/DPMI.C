...
#define LOAD_DS() _ASM_BEGIN _ASM(push ds) _ASM(pop es) _ASM(push dword ptr _DPMI_Addressing) _ASM(pop ds) _ASM_END
#define RESTORE_DS() _ASM_BEGIN _ASM(push es) _ASM(pop ds) _ASM_END
