...
#ifndef _RETROWAVE_H_    //#pragma once not working for Watcom
#define _RETROWAVE_H_
...
extern void retrowave_cmd_buffer_init(RetroWaveContext *ctx, RetroWaveBoardType board_type, uint8_t first_reg, uint32_t next_len);
