...
vpath_src=../ ../usbddos ../usbddos/class ../usbddos/dpmi ../usbddos/hcd ../RetroWav ../RetroWav/Platform ../RetroWav/Protocol ../RetroWav/Board 
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
LIBS= 
LD_EXTRA_FLAGS=
C_EXTRA_FLAGS=-fno-exceptions -march=i386
...
OBJFILES=Output/cdc.o Output/dbgutil.o Output/dos_cdc.o Output/dpmi.o\
	Output/dpmi_dj2.o Output/dpmi_tsr.o Output/emm.o Output/main.o\
	Output/ohci.o Output/OPL3.o Output/pci.o Output/RetroWav.o\
	Output/Serial.o Output/uhci.o Output/usb.o Output/usbtable.o\
	Output/xms.o
...
PROJECT_ITEMS=cdc.cpp dbgutil.cpp dos_cdc.cpp dpmi.c dpmi_dj2.c dpmi_tsr.c\
	emm.cpp main.cpp ohci.cpp OPL3.c pci.c RetroWav.c Serial.c uhci.cpp\
	usb.cpp usbtable.cpp xms.c
...
Output/cdc.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=dbgutil.cpp
Output/dbgutil.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=dos_cdc.cpp
Output/dos_cdc.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=dpmi.c
Output/dpmi.o:: $(DEPS_4)
	$(RHIDE_COMPILE.c.o)
DEPS_5=dpmi_dj2.c
Output/dpmi_dj2.o:: $(DEPS_5)
	$(RHIDE_COMPILE.c.o)
DEPS_6=dpmi_tsr.c
Output/dpmi_tsr.o:: $(DEPS_6)
	$(RHIDE_COMPILE.c.o)
DEPS_7=emm.cpp
Output/emm.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cpp.o)
DEPS_8=main.cpp
Output/main.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cpp.o)
DEPS_9=ohci.cpp
Output/ohci.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cpp.o)
DEPS_10=OPL3.c
Output/OPL3.o:: $(DEPS_10)
	$(RHIDE_COMPILE.c.o)
DEPS_11=pci.c
Output/pci.o:: $(DEPS_11)
	$(RHIDE_COMPILE.c.o)
DEPS_12=RetroWav.c
Output/RetroWav.o:: $(DEPS_12)
	$(RHIDE_COMPILE.c.o)
DEPS_13=Serial.c
Output/Serial.o:: $(DEPS_13)
	$(RHIDE_COMPILE.c.o)
DEPS_14=uhci.cpp
Output/uhci.o:: $(DEPS_14)
	$(RHIDE_COMPILE.cpp.o)
DEPS_15=usb.cpp
Output/usb.o:: $(DEPS_15)
	$(RHIDE_COMPILE.cpp.o)
DEPS_16=usbtable.cpp
Output/usbtable.o:: $(DEPS_16)
	$(RHIDE_COMPILE.cpp.o)
DEPS_17=xms.c
Output/xms.o:: $(DEPS_17)
	$(RHIDE_COMPILE.c.o)
all:: rwddos.exe
